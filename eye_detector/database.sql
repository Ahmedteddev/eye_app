--CREATE TABLE patient_info (patient_id INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT, pateint_name TEXT NOT NULL, patient_age I--NTEGER NOT NULL, patient_condition TEXT NOT NULL);
